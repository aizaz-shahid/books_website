<?php $__env->startSection('content'); ?>
   <h3>Obooko - Essential Tools - <b>Image Viewer/Deleter Book Covers Folder</b></h3>
  <hr size=1>

<div class="row">
<div class="col-sm-12">
<h4>Folder location <b>/images/covers/</b></h4>  
...
<p>
IMAGES ARE ALPHABETICALLY LISTED (10 images per tab)<br>
...
$dirFiles = array();
// opens images folder
if ($handle = opendir(public_path().'/images/covers')) {
...
foreach($dirFiles as $file)
{
      ...
      echo "<table border=1 cellpadding=2 cellspacing=2>";
			echo "<td width=50%><img src=\"public/images/covers/".$file."\"  height=\"100\"></td>";
			echo "<td width=45%><h6>Filename : ".$file."</h6></td>";
			
			echo "<td width=5%><form method=\"post\" name=\"deleteSomething\" action=\"/view_covers_images?delete=true\" >
