...
<div class="modal fade" id="login_modal" tabindex="-1" role="dialog"> 
	...
	<form name="form-1" action="<?php echo e(asset('')); ?>my-account" method="post" class="form" style="background:white;border:none;margin-bottom:0px;padding-left:30px;padding-right:30px;padding-bottom:0px;padding-top:0px">
	<div class="row">
		<div class="col-md-12">
...
">
    ...
    padding-left: 0px;
">
			<p style="color: #ff6600;text-align:center;font-size:16px;font-weight:900"><a href="<?php echo e(url('registration')); ?>"><strong>REGISTER FREE</strong></a></p>
		</div>
	</div>        
      </div>
    </div><!-- /.modal-content -->
...
<nav class="navbar navbar-default">
  ...
  <div class="navbar-header">
   ...
   <a class="navbar-brand" href="<?php echo e(asset('')); ?>ebooks-books">
<img src="<?php echo e(asset('/public')); ?>/images/obooko.png" alt="obooko"></a>
   ...
   <span class="icon-bar"></span>
    ...
    <span class="icon-bar"></span>
     ...
     <form class="navbar-form navbar-right" style="margin-right:0px" role="search" action="<?php echo e(asset('')); ?>search-result" method="get">
     <?php else: ?>
 <form class="navbar-form navbar-right" style="margin-right:0px" role="search" action="<?php echo e(asset('')); ?>search-result" method="get">
 <?php endif; ?>
...
<?php endif; ?>
    ...
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Free Fiction<span class="caret"></span></a>
		...
		<?php foreach($resultSet11 as $result11): ?>
                    <li><a href="<?php echo e(asset('')); ?>category/<?php echo e($result11->slug); ?>"><?php echo e($result11->name); ?></a></li>
		<?php endforeach; ?>
                                      </ul>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
		<?php foreach($resultSet12 as $result12): ?>
                    <li><a href="<?php echo e(asset('')); ?>category/<?php echo e($result12->slug); ?>"><?php echo e($result12->name); ?></a></li>
		<?php endforeach; ?>
                                      </ul>
                </li>
                <li class="dropdown">
...
<ul class="dropdown-menu" role="menu">
    ...
    <!--<li><a href="">About obooko</a></li>-->
      <?php if(Session::has('id')): ?>         
     <li><a href="<?php echo e(url('submit-book')); ?>">submit book</a></li>
     <?php else: ?>
   ...
   <!--<li><a href="">Terms and Conditions</a></li>-->
     ...
     <li><a href="/contact-us">Contact Us</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo e(url('my-account')); ?>">View Your Account</a></li>
		...
		<li><a href="<?php echo e(url('registration')); ?>">Register</a></li>
                <?php endif; ?>
                <li><a href="<?php echo e(url('blog-gallery')); ?>">Blog</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
