...
<html lang="en">
  <head>
    ...
    <title><?php echo e($resultSet->m_title); ?></title>
    <meta  name="viewport"  content="width=device-width, initial-scale=1, maximum-scale=1">
<?php if($resultSet->robot_index == "on"): ?>
<meta name="robots" content="noindex" /> 
<?php endif; ?>
 <meta name="description" content="<?php echo e($resultSet->m_description); ?>">
...
.modal-dialog {
  ...
  <body>
    <div  class="container">
      <header>
        <div  class="banner"><img  src="../../public/images/<?php echo e($cat->h_image); ?>"  alt="<?php echo e($cat->h_image_alt); ?>" title="<?php echo e($cat->h_image_alt); ?>"></div>
        <h1  class="header__tag"><?php echo e($resultSet->h_text); ?></h1>
        <div  class="row access-txt mttop33">
          <div  class="col-sm-4">
            <p><?php echo e($resultSet->t_text); ?></p>
          </div>
<?php if($resultSet->adult_filter == "on"): ?>
          <div  class="col-sm-12 col-md-8 xs-center"  style="padding-left:0px;"><?php echo $advert->a17; ?></div>
<?php else: ?>
...
<?php endif; ?>
 ...
 <?php echo $__env->make('shared.nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <section  class="mttop33">
        <div  class="row submission msg">
          <div  class="col-sm-4 col-md-3"> <img style="width:235px;height:341px" title="<?php echo e($resultSet->title); ?>"
               src="../../public/images/covers/<?php echo e($resultSet->cover_image); ?>"
               alt="<?php echo e($resultSet->image_alt); ?>"
               class="bookcover">
          </div>
          <div  class="col-sm-12 col-md-8 col-dw-6">
            <h3><?php echo e($resultSet->title); ?> <br>
              <span  class="gray" style="padding-top:8px;display:block;">By <?php echo e($resultSet->author_name); ?><br>
              </span></h3>
       <p class="graycolor">Officially licensed for obooko members.<span style='font-weight:bold;margin-left:5px;color:#000;'> <?php echo e(($resultSet->adult_filter == 'on') ? 'Age Rating 17+' : ''); ?></span></p>
            <hr>
			...
			<ul class="star-rating" id="rater_<?php echo e($resultSet->book_id); ?>">
				<li class="current-rating" style="width:<?php echo e(($resultSet->rating/5)*100); ?>%;" id="ul_<?php echo e($resultSet->book_id); ?>"></li>
				<li><a onclick="rate('1','<?php echo e($resultSet->book_id); ?>'); return false;" href="#"  title="1 star out of 5" class="one-star" >1</a></li>
				<li><a onclick="rate('2','<?php echo e($resultSet->book_id); ?>'); return false;" href="#" title="2 stars out of 5" class="two-stars">2</a></li>
				<li><a onclick="rate('3','<?php echo e($resultSet->book_id); ?>'); return false;" href="#" title="3 stars out of 5" class="three-stars">3</a></li>
				<li><a onclick="rate('4','<?php echo e($resultSet->book_id); ?>'); return false;" href="#" title="4 stars out of 5" class="four-stars">4</a></li>
				<li><a onclick="rate('5','<?php echo e($resultSet->book_id); ?>'); return false;" href="#" title="5 stars out of 5" class="five-stars">5</a></li>
			</ul>
 <div class="rated_text" style="margin-top:10px;font-size:12px;">Rated <span id="outOfFive_<?php echo e($resultSet->book_id); ?>" class="out5Class"><?php echo e($resultSet->rating); ?></span>/5(<span id="showvotes_<?php echo e($resultSet->book_id); ?>" class="votesClass" style="padding-top: 10px; padding-bottom: 0px; margin: 0px;"><?php echo e($resultSet->total_votes); ?> votes</span>)</div>
            ...
            <form action="<?php echo e(asset('')); ?>send-feedback" method="post">
            <input type="hidden" name="author" value="<?php echo e($resultSet->author_id); ?>">
            <input type="hidden" name="title" value="<?php echo e($resultSet->title); ?>">
 ...
 <?php echo csrf_field(); ?>
        ...
        <h4>Book Synopsis</h4>
        <article id="s_t1" style="margin-bottom:20px"><?php echo $Synopsis; ?><br/>
 <a class="read_more" href="javascript:void(0)" onClick="togle();">Read more</a></article>
	<article id="s_t2" style="display:none;margin-bottom:20px"><?php echo $resultSet->synopsis; ?>

 <a class="show_more below" href="javascript:void(0)" onClick="togle();">Read less</a></article>
 
 		<h4>Catch up with the author online:</h4>
        <p>
             <a  href="<?php echo e($resultSet->web); ?>"><?php echo e($resultSet->web); ?></a><br>
             <a  href="<?php echo e($resultSet->blog); ?>"><?php echo e($resultSet->blog); ?></a> <br>
             <a  href="<?php echo e($resultSet->fb); ?>"><?php echo e($resultSet->fb); ?></a> <br>
             <a  href="<?php echo e($resultSet->twitter); ?>"><?php echo e($resultSet->twitter); ?></a> <br>
        </p>
            ...
            <div  class="bookheading">SELECT FREE EBOOK FORMAT</div>
            	<div  class="freebook" style="border: 2px solid;border-color: #ff6600;padding:16px;">
                    ...
                    <?php if(Session::has('id')): ?>
                        ...
                        <form name="download_form" id="download_form" action="<?php echo e(asset('')); ?>download-page" method="post">
			    ...
			    <?php endif; ?>
                        ...
                        <input type="hidden" name="id" value="<?php echo e($resultSet->book_id); ?>">
                        <!--<div  class="col-sm-6 ">
...
because the author
 ...
 ebook editions.</p>
        ...
        <div  class="books" style="margin-left:15px;">
          ...
          <div  class="row" style="margin-top:15px;">
          	...
          	<?php foreach($resultSet2 as $result2): ?>
		
            <div  class="col-md-2 col-sm-3 col-xs-3" style="margin-bottom:15px;margin-left:0px;padding-left:0px;padding-right:0px;margin-right:16px"><a  href="<?php echo e(asset('')); ?>download/<?php echo $result2->category; ?>/<?php echo $result2->url; ?>"><img  src="../../public/images/covers/<?php echo e($result2->cover_image); ?>"
 alt="Cover"
 title="Cover"
 ...
 class="book-border"></a></div>-->
        ...
        <div  class="col-sm-12 col-md-4 col-lg-3 section3">
            ...
            <?php foreach($resultSet3 as $result3): ?>
            	<div  class="media book-cover" style="margin-bottom:15px !important;">
                  <a  class="pull-left"  href="<?php echo e(asset('')); ?>download/<?php echo $result3->category; ?>/<?php echo $result3->url; ?>">
                    <img  class="media-object"  style="  padding: 2px 2px;width: 82px;
  height: 119px" src="../../public/images/covers/<?php echo e($result3->cover_image); ?>"  alt="<?php echo e($result3->image_alt); ?>" title="<?php echo e($result3->image_alt); ?>">
                  </a>
                  <div  class="media-body">
                    <a href="<?php echo e(asset('')); ?>download/<?php echo $result3->category; ?>/<?php echo $result3->url; ?>" style="text-decoration:none"><h4  class="media-heading"><?php echo e($result3->title); ?></h4></a>
                    <em class="author">by <?php echo e($result3->author_name); ?></em>
					<span  class="latest-books__item-p"><?php echo $result3->synopsis; ?>...</span>
                  </div>
                </div>
            <?php endforeach; ?>    
                <!--<div  class="media">
...
<?php endif; ?>
            ...
            <?php if($resultSet->adult_filter == "on"): ?>
            <div  class="mttop33 dn"><?php echo $advert->b17; ?></div>
            <?php else: ?>
            <div  class="mttop33 dn"><?php echo $advert->b; ?></div>
...
var current_rate=<?php echo e($resultSet->rating); ?>;
...
$(function(){
    $('#star-rating').rating(function(vote, event){
      var b_id=<?php echo e($resultSet->book_id); ?>;
