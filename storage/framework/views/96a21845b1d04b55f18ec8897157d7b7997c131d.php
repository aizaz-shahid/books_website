...
<div class="container">
<header>
	<div class="banner"><img src="<?php echo e(asset('/public')); ?>/images/TRULY-FREE-EBOOKS.png" alt="TRULY-FREE-EBOOKS"></div>
...
<section class="mttop33">
    <div class="row">
    	<div class="col-md-6">
            ...
            <div class="video"><video style="width:100%" src="<?php echo e(asset('/public')); ?>/video/obooko-welcome.mp4" controls ></video></div>
        </div> 
		...
		<p style='padding:0 0 0 0;margin-bottom: 25px;'>
					No waiting! Sign-up and start downloading ebooks straightaway.
		...
		<?php endif; ?>
                ...
                <div class="col-sm-8 col-md-7"><input type="text" name="firstname" value="<?php echo e(isset($firstname) ? $firstname : ''); ?>" id="fname" required></div>
		
		<div class="col-sm-4 col-md-5"><label>Your Last Name</label></div>
                <div class="col-sm-8 col-md-7"><input type="text" name="lastname" value="<?php echo e(isset($lastname) ? $lastname : ''); ?>" id="lname" required></div>
                
                <div class="col-sm-4 col-md-5"><label>Email Address</label></div>
                <div class="col-sm-8 col-md-7"><input required="" name="email" id="email" value="<?php echo e(isset($email) ? $email : ''); ?>" type="text"></div>

		

		<!--<div class="col-sm-4 col-md-5"><label>Enter a Username</label></div>
                <div class="col-sm-8 col-md-7"><input required="" name="username" id="username" value="<?php echo e(isset($username) ? $username : ''); ?>" type="text"></div>-->
                
                <div class="col-sm-4 col-md-5"><label>Enter a Password</label></div>
                <div class="col-sm-8 col-md-7"><input name="password" value="<?php echo e(isset($password) ? $password : ''); ?>" id="password" maxlength="50" size="26" type="password"></div>
                ...
                <div class="mttop25">
                    ...
                    <div class="col-sm-4 col-md-5 mttop10"><?php echo captcha_img(); ?></div>
		...
		<div class="col-sm-12" style='margin-top: 20px;'><span style="color:#F60">Please wait for confirmation page to load.</span> Problems with form? See <a href='http://www.obooko.com/free-ebooks//info-faq'>FAQ</a></div>
