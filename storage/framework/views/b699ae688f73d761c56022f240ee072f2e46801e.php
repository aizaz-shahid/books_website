...
<html lang="en">
<head>
    <title>First Book Submission</title>
    <meta charset="utf-8" />
...
<div class="container">
<header>
	<div class="banner"><img src="<?php echo e(asset('/public')); ?>/images/SUBMIT-YOUR-BOOK.png" alt="Banner"></div>
...
<div class="col-sm-2 col-md-3"><label>Optional Link</label></div>
           ...
           <div class="col-xs-12 col-sm-10 col-md-8 mttop10">
