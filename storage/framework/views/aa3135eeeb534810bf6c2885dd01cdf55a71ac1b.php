...
<body>
	...
	<?php if($name!="Admin"): ?>
	 ...
	 <br><p>
Don’t forget to share a link to <a href="http://www.obooko.com/">obooko.com</a> with your friends.
<br><br>
Enjoy reading!
<br><br>
Sarah Bainbridge<br>
Membership Administration</p>
	<?php else: ?>
	This is to inform you that a member named <?php echo e($Name); ?> has been registered on the site.
	<?php endif; ?>
	</p><br>
