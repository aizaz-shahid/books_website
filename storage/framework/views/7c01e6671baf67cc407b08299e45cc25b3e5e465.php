...
Only one download is recorded per unique user: subsequent downloads by the same person are not recorded.</p>
        ...
        <?php foreach($resultSet as $result): ?>
        	<div class="col-sm-12">
            	<a href="<?php echo e(asset('')); ?>download/<?php echo $result->category; ?>/<?php echo $result->url; ?>" onClick="submit_form();"><?php echo e($result->title); ?></a>
                
                
                <ul>
                	<li>PDF <span><?php echo e($result->pdf_downloads); ?></span></li>
                    <li>EPUB <span><?php echo e($result->epub_downloads); ?></span></li>
                    <li>KINDLE <span><?php echo e($result->kindle_downloads); ?></span></li>
                </ul>
            </div>
        <?php endforeach; ?>
            <!--<div class="col-sm-12">
