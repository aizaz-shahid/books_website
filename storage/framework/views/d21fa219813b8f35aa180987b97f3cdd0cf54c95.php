...
<b>Blog Writer</b><br><textarea class='form-control' rows=1 name='blwriter'><?php echo e($blog->writer); ?></textarea><p>

<b>Blog Image 1</b> - 
<?php echo e($blog->image); ?>

<br><div class='row'><div class='col-sm-4 col-xs-12'><img class='img-responsive' src='/public/images/<?php echo e($blog->image); ?>'></div>
...
<b>Image alt</b><br><textarea class='form-control' rows=1 name='img_alt'><?php echo e($blog->img_alt); ?></textarea><p>
<p><b>Blog Text1</b><br><textarea id="my-editor" class='ckeditor form-control' rows=1 name='bltext1'><?php echo old('bltext1', $blog->article); ?></textarea><p>
<script>
  CKEDITOR.replace( 'my-editor', {
    filebrowserImageBrowseUrl: '/laravel-filemanager/r/b?type=Images',
    filebrowserImageUploadUrl: '/laravel-filemanager/r/b/upload?type=Images&_token=<?php echo e(csrf_token()); ?>',
    filebrowserBrowseUrl: '/laravel-filemanager/r/b/?type=Files',
    filebrowserUploadUrl: '/laravel-filemanager/r/b/upload?type=Files&_token=<?php echo e(csrf_token()); ?>'
  });
</script>
...
<p><input type='hidden' name='blid' value='<?php echo e($blog->post_id); ?>'>
