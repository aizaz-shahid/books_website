...
<div class="container">
<header>
	<div class="banner"><img src="<?php echo e(asset('/public')); ?>/images/author-feedback.png" alt="Banner"></div>
...
<!--<a href="#"><img src="images/email.png" alt="email" class="mttop10"></a></p>-->
        	...
        	<form name="form" action="<?php echo e(asset('')); ?>send-feedback-form" method="post" class="form mttop32">
<?php if(isset($Error)): ?>          
<p><?php echo e($Error); ?></p>
<?php endif; ?>
                <div class="row">
                
                <input type="hidden" name="author" value="<?php echo e($result); ?>">
              	<input type="hidden" name="title" value="<?php echo e($result2); ?>">
              	<div class="col-sm-2 col-md-3"><label>Book Title:</label></div>
                <div class="col-sm-10 col-md-9"><input type="text" name="title" id="title" value="<?php echo e($result2); ?>" class="fiftyper" required></div>
