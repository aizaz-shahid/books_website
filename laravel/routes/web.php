...
Route::get('/laravel', function () {
    return redirect('laravel/ebooks-books');
});
...
Route::get('laravel/ebooks-books', 'bookCatalogueController@setIndex' );
Route::get('/category/{category}', 'bookCatalogueController@category_redirect');
Route::get('/{category}/{url}', 'bookCatalogueController@downloadPage');
