...
{{$book->cover_image}}
<br><div class='row'><div class='col-sm-4 col-xs-12'><img class='img-responsive' src='images/covers/{{$book->cover_image}}'></div><div class='col-sm-8 col-xs-12'>
     ...
     <table class="table table-bordered" style="margin-top:10px">
         <tbody>
             <tr>
                 ...
                 <td><?=($book->pdf != "") ? '<a target="_blank" href="/books/pdf/'.$book->title.'.pdf">/books/pdf/'.$book->title.'.pdf</a>' : ''?></td>
             </tr>
             <tr>
                 <th>EPUB</th>
                 <td>
                 ...
                 <td><?=($book->epub != "") ? '<a target="_blank" href="/books/epub/'.$book->title.'.epub">books/epub/'.$book->title.'.epub</a>' : ''?></td>
             </tr>
             <tr>
                 <th>KINDLE</th>
                 <td>
                 ...
                 <td><?=($book->kindle != "") ? '<a target="_blank" href="/books/kindle/'.$book->title.'.kindle">/books/kindle/'.$book->title.'.kindle</a>' : ''?></td>
             </tr>
         </tbody>
     </table>
         </div>
