...
{{$mainpage->h_image}}
<br><div class='row'><div class='col-sm-6 col-xs-12'><img class='img-responsive' src='images/{{$mainpage->h_image}}'></div>
...
{{$mainpage->img1}}
<br><div class='row'><div class='col-sm-6 col-xs-12'><img class='img-responsive' src='images/{{$mainpage->img1}}'>
...
?>
 ...
 <b>Right Middle Image 2</b> - 
{{$mainpage->img2}}
<br><div class='row'><div class='col-sm-6 col-xs-12'><img class='img-responsive' src='images/{{$mainpage->img2}}'></div>
<div class='col-sm-6 col-xs-12'>
