...
@endif
 <meta name="description" content="{{$resultSet->m_description}}">
    ...
    <link  rel="stylesheet"  href="../css/rating_css.css">
	<style>
.book-cover{
margin-bottom:1.49em !important;
  ...
  <body>
    <div  class="container">
      <header>
        <div  class="banner"><img  src="../images/{{$cat->h_image}}"  alt="download ebooks"></div>
            ...
            <div  class="bookheading">SELECT FREE EBOOK FORMAT</div>
            	<div  class="freebook" style="border: 2px solid;border-color: #ff6600;padding:16px;">
                    ...
                    @if(Session::has('id'))
                        ...
                        <form name="download_form" id="download_form" action="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/download-page" method="post">
			    ...
			    @endif
                    ...
                    @else
                      <div  class="col-sm-8"><div style="margin-bottom: 22px; text-align: center ! important; width: 249px;">From available file formats*</div>
                          
                          <input  class="mttop32"  value="Login or Register to Download"  id="submit"  name="submit"
 style="margin-top: -10px;margin-bottom:11px;"
 ...
 ebook editions.</p>
        ...
        <div  class="books" style="margin-left:15px;">
          ...
          <div  class="row" style="margin-top:15px;">
            ...
            <div  class="col-md-2 col-sm-4 col-xs-6" style="margin-bottom:15px;margin-left:0px;padding-left:0px;padding-right:0px;margin-right:16px"><a  href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/{!! $result2->category !!}/{!! $result2->url !!}"><img  src="../images/covers/{{$result2->cover_image}}"
 alt="Cover"
        ...
        <div  class="col-sm-12 col-md-4 col-lg-3 section3">
            ...
            @foreach($resultSet3 as $result3)
            	<div  class="media book-cover" style="margin-bottom:15px !important;">
                  <a  class="pull-left"  href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/{!! $result3->category !!}/{!! $result3->url !!}">
                    <img  class="media-object"  style="  padding: 2px 2px;width: 82px;
  height: 119px" src="../images/covers/{{$result3->cover_image}}"  alt="{{$result3->image_alt}}">
                  </a>
                  <div  class="media-body">
                    <a href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/{!! $result3->category !!}/{!! $result3->url !!}" style="text-decoration:none"><h4  class="media-heading">{{$result3->title}}</h4></a>
