...
<div class="container">
<header>
	<div class="banner"><img src="images/{{$mainpage->h_image}}" alt="{{$mainpage->h_alt}}"></div>
...
<section class="main mttop33">
    	...
    	<div class="col-sm-7 col-md-4 col-lg-5 section1">
            ...
            @foreach($resultSet as $result)
                <div class="media book-thumb">
                  <a class="pull-left" href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/{!! $result->category !!}/{!! $result->url !!}">
                    <img class="media-object" style="  padding: 1px 1px;
  width: 82px;
  height: 119px" src="images/covers/{{$result->cover_image}}" alt="{{$result->image_alt}}">
                  </a>
                  <div class="media-body">
                    <a href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/{!! $result->category !!}/{!! $result->url !!}"><h4 class="media-heading">{{$result->title}}</h4></a>
        ...
        <div class="col-sm-5 col-md-4 col-lg-3 section2">
            ...
            <div class="thumbnail">
              <img src="images/{{$mainpage->m1_image}}"  alt="{{$mainpage->m1_alt}}"></a>
              <div class="caption">
 ...
 <a class="show_more below" href="javascript:togle(0)">Read less</a></div>
	...
	<div class="thumbnail">
              <img src="images/{{$mainpage->m2_image}}"  alt="{{$mainpage->m2_alt}}"></a>
              <div class="caption">
        ...
        <div class="col-sm-12 col-md-4 col-lg-3 section3">
        	<div class="blog" style="border:solid rgb(187,187,187) 1px;padding:10px">
                ...
                @foreach($resultSet4 as $result4)
                  <li class="media">
                    <a class="pull-right" href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/blog-post/article/{{$result4->post_id}}">
                      <img style="  padding: 2px 2px;height:70px;width:70px;over-flow:hidden;"
  

   class="media-object" src="/resize?image=images/{{$result4->image}}&h=70" alt="Blog">
                    </a>
                    <div class="media-body">
                      <a href="http://ec2-54-149-113-132.us-west-2.compute.amazonaws.com/blog-post/article/{{$result4->post_id}}"><h4 class="media-heading">{{$result4->title}}</h4></a>
