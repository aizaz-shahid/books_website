...
<br><div class='row'><div class='col-sm-6 col-xs-12'><img class='img-responsive' src='/public/images/{{$newpage->h_image}}'></div>
...
@if($newpage->slug != "" || $newpage->slug != " ")
 <p>
             <b>Page Url</b><br><input type=text" class="form-control" disabled name="slug_url" value="{{ asset('') }}page/{{$newpage->slug}}">
     </p>
@endif
       <p>
