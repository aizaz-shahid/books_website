  ...
  <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="adsense_pane">
        <div class="form-group">
            <label>728x90</label>
            <textarea name="ga_728_90" class="form-control" rows="8">{{$advert->a}}</textarea>
        </div>
           <div class="form-group">
            <label>300x250</label>
            <textarea name="ga_300_250" class="form-control" rows="8">{{$advert->b}}</textarea>
        </div>
           <div class="form-group">
            <label>300x600</label>
            <textarea name="ga_300_600" class="form-control" rows="8">{{$advert->c}}</textarea>
        </div>
      </div>
    <div role="tabpanel" class="tab-pane" id="adult_pane">
        <div class="form-group">
            <label>728x90</label>
            <textarea class="form-control" rows="9" name="alt_728_90">{{$advert->a17}}</textarea>
        </div>
	<div class="form-group">
            <label>300x250 (1)</label>
            <textarea class="form-control" rows="9" name="alt_300_250">{{$advert->b17}}</textarea>
        </div>
        <div class="form-group">
            <label>300x250 (2)</label>
	<textarea class="form-control" rows="9" name="alt_300_250_2">{{$advert->c17}}</textarea>
        </div>
