                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                            <span style="font-size:16px;">
                                                    ...
                                                    <a href='{{ URL::to('/edit_adminuser?id='.$user->id) }}'>{{$user->username}}</b>, &nbsp;
                                                     {{$user->email}}
                                                    </a>
                                            </span>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                            <span style="font-size:16px;">
                                                    <a href='{{ URL::to('/edit_adminuser?id='.$user->id) }}'>
                                    ...
                                    <div class="col-sm-2">
                                         ...
                                         <?php if($user->email != "tony@moontalk.com"): ?>
                                                    <a href='{{ URL::to('/delete_adminuser?id='.$user->id) }}' onclick="return confirm('Are you sure you want to delete this item?');">
