...
<div class="container">
<header>
	<div class="banner"><img src="{{ asset('/public') }}/images/SEND-US-A-MESSAGE.png" alt="Banner"></div>
...
<section class="mttop33">
	...
	<div class="block dn" style="margin-top:5px;">
            ...
            <div class="block dn" style="margin-top:5px;">
       	    	<img src="{{ asset('/public') }}/images/legal-downloads.jpg" alt="legal-download"> 
            </div>
		<div class="block dn" style="margin-top:5px;">
       	    	<div>{!! $Advert->b !!}</div> 
            </div>
...
<a href="#"><img src="{{ asset('/public') }}/images/email.png" alt="email" class="mttop10"></a></p>
	...
	@endif
                ...
                <div class="col-sm-10 col-md-9">
                    <select name="subject" class="fourty" value="{{old('subject')}}">
                ...
                <div class="col-sm-10 col-md-9"><input type="text" name="name" id="Name" value="{{old('name')}}" class="fourty" required></div>
                
                <div class="col-sm-2 col-md-3"><label>Email Address:</label></div>
                <div class="col-sm-10 col-md-9"><input type="text" name="email" id="email" value="{{old('email')}}" class="fiftyper" required></div>
                
                <div class="col-sm-2 col-md-3"><label>Confirm Email</label></div>
                <div class="col-sm-10 col-md-9"><input type="text" name="c_email" id="c_email" value="{{old('c_email')}}" class="fiftyper" required></div>
                
       		  <div class="col-sm-2 col-md-3"><label>Message:</label></div>
              <div class="col-sm-10 col-md-9"><textarea name="message" cols="5" rows="8" value="{{old('message')}}" required></textarea></div>
