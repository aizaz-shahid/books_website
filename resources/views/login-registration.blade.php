...
<div class="container">
<header>
	<div class="banner"><img src="{{ asset('/public') }}/images/TRULY-FREE-EBOOKS.png" alt="TRULY-FREE-EBOOKS"></div>
...
<section class="mttop33">
    <div class="row">
    	<div class="col-md-6">
            ...
            <div class="video"><video style="width:100%" src="{{ asset('/public') }}/video/obooko-welcome.mp4" controls ></video></div>
        </div> 
